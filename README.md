...
- [FATCHIP-GmbH/plugin-oxid6-klarna](https://github.com/FATCHIP-GmbH/plugin-oxid6-klarna) ([v5.6.4](https://github.com/FATCHIP-GmbH/plugin-oxid6-klarna/releases/tag/v5.6.4), 3 weeks ago) - Klarna Checkout and Klarna Payments Module for the OXID eShop version &gt;= 6.0.0
...
- [add template block around account dashboard items](https://github.com/OXID-eSales/apex-theme/pull/66) on [OXID-eSales/apex-theme](https://github.com/OXID-eSales/apex-theme) (9 months ago)
